...
Open Source Software: Translator from Korean to English.
...
#### 3). Write a C program of the Translator.
   - On the File.
#### 4). Fine-Tune the Model and Run
   - The result is in the image file.
